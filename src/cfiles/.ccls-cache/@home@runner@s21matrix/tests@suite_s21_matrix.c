...
Suite *suite_s21_matrix(void) {
  ...
  tcase_add_test(tc23, s21_create_matrix_1);
  tcase_add_test(tc23, s21_create_matrix_2);
  tcase_add_test(tc23, s21_create_matrix_3);
  tcase_add_test(tc23, s21_create_matrix_4);
  tcase_add_test(tc23, s21_create_matrix_5);
  tcase_add_test(tc23, s21_eq_matrix_1);
  tcase_add_test(tc23, s21_eq_matrix_2);
  tcase_add_test(tc23, s21_eq_matrix_3);
  tcase_add_test(tc23, s21_eq_matrix_4);
  tcase_add_test(tc23, s21_sum_matrix_1);
  tcase_add_test(tc23, s21_sum_matrix_2);
  tcase_add_test(tc23, s21_sum_matrix_3);
  tcase_add_test(tc23, s21_sub_matrix_1);
  tcase_add_test(tc23, s21_sub_matrix_2);
  tcase_add_test(tc23, s21_sub_matrix_3);
  tcase_add_test(tc23, s21_mult_number_1);
  tcase_add_test(tc23, s21_transpose_1);
  tcase_add_test(tc23, s21_transpose_2);
  tcase_add_test(tc23, s21_determinant_1);
  tcase_add_test(tc23, s21_determinant_2);
  tcase_add_test(tc23, s21_determinant_3);
  tcase_add_test(tc23, s21_calc_complements_1);
  tcase_add_test(tc23, s21_calc_complements_2);
  tcase_add_test(tc23, s21_calc_complements_3);
  tcase_add_test(tc23, s21_calc_complements_4);
  tcase_add_test(tc23, s21_inverse_matrix_1);
  tcase_add_test(tc23, s21_inverse_matrix_2);
  tcase_add_test(tc23, s21_inverse_matrix_3);
  tcase_add_test(tc23, s21_inverse_matrix_4);
  tcase_add_test(tc23, s21_inverse_matrix_5);
  tcase_add_test(tc23, s21_mult_matrix_1);
  tcase_add_test(tc23, s21_mult_matrix_2);
  tcase_add_test(tc23, s21_mult_matrix_3);
  tcase_add_test(tc23, s21_mult_matrix_4);
